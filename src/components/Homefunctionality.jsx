        ...
        <div className='grid grid-col-1 lg:grid-cols-2 md:grid-rows-1 gap-0 pb-10 w-full'>
            <div className='flex pt-5 px-5 md:pl-5 md:pr-5'>
                <div className='flex items-start justify-start relative'>
                    <img alt="" className='w-screen h-screen' src={Accessories1} />
                </div>
                <div className='flex flex-col items-start absolute pt-10 pl-3 sm:pl-10'>
                    ...
                    <NavLink className="text-gray-900 bg-gray-100 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-3xl text-sm px-5 py-3 text-center inline-flex items-center mr-2 mb-2 w-36 justify-center" to="/customize">Customize Now</NavLink>
            ...
            <div className='flex flex-col flex-wrap gap-10 pt-5'>
                <div className='flex px-5 md:pr-5 lg:pl-0 md:pl-5 '>
                    <div className='flex items-start justify-start relative'>
                        <img alt="" className='max-w-full w-screen min-h-64 h-80' src={Accessories2} />
                    </div>
                    <div className='flex flex-col flex-wrap items-start absolute pt-10 pl-3 sm:pl-10'>
                        ...
                        <button className="text-gray-900 bg-gray-100 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-3xl text-sm px-5 py-3 text-center inline-flex items-center dark:focus:ring-gray-500 mr-2 mb-2 w-36 justify-center" type="button">
                            Purchase Now
                        </button>
                    </div>
                ...
                <div className='flex flex-col md:flex-row'>
                    <div className='flex rounded-4xl px-5 md:pl-5 md:pr-0'>
                        <div className='flex items-start justify-start relative'>
                            <img alt="" className='max-w-full w-screen min-h-64 h-80 bg-cover rounded-2xl' src={Accessories3} />
                        </div>
                    ...
                    <div className='flex rounded-4xl px-5 pt-5 md:pt-0 md:pr-5 '>
                        <div className='flex items-start justify-start relative'>
                            <img alt="" className='max-w-full w-screen h-80 ' src={Accessories4} />
                        </div>
