...
const PaymentPage = () => {
    ...
    const handleOptionChange = (event) => {
        setSelectedOption(event.target.id); // Update the selected option when a payment method is clicked
    };
    return (
        <div >
            <div class="w-screen bg-gray-200 flex items-center justify-center px-5 pb-10 pt-16">
                <div class=" mx-auto rounded-lg bg-white shadow-lg p-10 text-gray-700">
                    ...
                    <div class="mb-3 flex -mx-2">
                        <div class="px-2">
                            <label for="type1" class="flex items-center cursor-pointer">
                                <input type="radio" class="form-radio h-5 w-5 text-indigo-500" name="type" id="type1" checked={selectedOption === 'type1'} onChange={handleOptionChange}/>
                                <img src="https://leadershipmemphis.org/wp-content/uploads/2020/08/780370.png" class="h-8 ml-3" />
                            </label>
                        </div>
                        <div class="px-2">
                            <label for="type2" class="flex items-center cursor-pointer">
                                <input type="radio" class="form-radio h-5 w-5 text-indigo-500" name="type" id="type2" checked={selectedOption === 'type2'} onChange={handleOptionChange}/>
