        ...
        <>
            <nav aria-label="Page navigation example">
                <ul className="list-style-none flex gap-2.5">
                    <li>
                        <a
                            className="pointer-events-none relative block rounded bg-stone-100 px-2.5 py-1 text-sm text-black transition-all duration-300 hover:bg-neutral-700 hover:text-white"
                        >Previous</a>
                    </li>
