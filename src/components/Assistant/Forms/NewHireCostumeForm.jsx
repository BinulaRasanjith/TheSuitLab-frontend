...
// import { addHireCostume } from "../../../api/accessoryAPI";
...
const NewHireCostume = ({ isOpen, onClose }) => {
    const [newCostumeData, setNewCostumeData] = useState({
        ...
        // COAT
        lapel: null, // COLLAR
        pockets: null, // POCKET WARGE
        pocketColor: null,
        sleeveButton: null, // ATHE BUTTON GAANA

        // COMMON
        buttons: null, // ISSARAHA BUTTON GAANA STYLE KIYANNE EKATAMAI
        buttonColor: null,

        // TROUSER
        vent: null, // FOLT EKE SIZE EKA WENAS WENA EKA (MD, LG)
        backPocket: null, // BUTTON EKA AVAILABLE OR NOT
    ...
    const handleAddUserClick = async (event) => {
        ...
        try {
            ...
            formData.append("brand", newCostumeData.brand);
            formData.append("itemName", newCostumeData.itemName);
            formData.append("materialType", newCostumeData.materialType);
            formData.append("colorCode", newCostumeData.colorCode);
            formData.append("price", newCostumeData.price);
            formData.append("accessoryType", newCostumeData.accessoryType);
            formData.append("pattern", newCostumeData.pattern);
            formData.append("buckleType", newCostumeData.buckleType);
            formData.append("shoeStyle", newCostumeData.shoeStyle);
