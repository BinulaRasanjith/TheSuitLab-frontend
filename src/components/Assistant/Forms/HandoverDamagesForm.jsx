        ...
        <div className={`relative  ${isOpen ? 'block' : 'hidden'}`}>
            ...
            <div className="fixed top-16 bottom-0 right-0 left-0 z-40 flex flex-col items-center justify-center">
                <div className=" z-50 m-8 max-w-md w-1/3 rounded-lg bg-white p-8 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]">
                    ...
                    {/* <div className="mb-4 text-2xl font-semibold text-">
                        Collecting rented suit
                    </div> */}
                    <div className="mb-4 font-semibold">Suit ID:</div>
                    <div className="mt-5 mb-2 font-medium italic">*Check the suit and mark if required:</div>
                    ...
                    <button
                        type="submit"
                        className="w-full px-4 py-2 text-white bg-primary rounded hover:bg-primary-600 focus:outline-none focus:ring focus:ring-primary-200"
                    >
                        Handover
                    </button>
                </form>
