    ...
    return (
        <div className="p-3 flex flex-col items-start overflow-y-auto h-screen border-r-4 border-gray-400">
            ...
            <div className="my-2">
                ...
                <div className='flex justify-around p-2'>
                    <button className='bg-gray-200 rounded-xl py-1 px-3 m-1'>Jacket</button>
            ...
            <div className="my-2">
                ...
                <div className="flex justify-around p-2">
                    <button className='bg-gray-200 rounded-xl py-1 px-3 m-1'>Signature Standard Fit</button>
                    <button className='bg-gray-200 rounded-xl py-1 px-3 m-1'>Euro Slim Fit</button>
                    <button className='bg-gray-200 rounded-xl py-1 px-3 m-1'>Custom</button>
                </div>
            </div>
            <div className="flex-col my-2">
                ...
                <div className="flex justify-between p-2">
                    <div className="flex flex-col rounded-lg items-center justify-center px-4 py-1 bg-gray-200 w-20 m-1">
                        ...
                        <input className="bg-white py-0.5 px-4  rounded-lg w-16 mx-2 my-1" placeholder="inch" type="number" />
                    </div>
                    <div className="flex flex-col rounded-lg items-center justify-center px-4 py-1 bg-gray-200 w-20 m-1">
                ...
                <div className="flex justify-around p-2">
                    {
                        standards && standards.map((item, index) => (
                            <div className="flex items-center justify-center bg-gray-200 rounded-full m-2" key={index}>
