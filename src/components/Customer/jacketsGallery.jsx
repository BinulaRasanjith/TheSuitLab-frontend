...
const jacketData = [
    ...
    { id: 9, image: jacket9, label: "Plain Toe Genuine Leather Dress Shoes", to: "9" },
    { id: 10, image: jacket10, label: "Plain Toe Genuine Leather Dress Shoes", to: "10" },
    { id: 11, image: jacket11, label: "Plain Toe Genuine Leather Dress Shoes", to: "11" },
    { id: 12, image: jacket12, label: "Plain Toe Genuine Leather Dress Shoes", to: "12" },
    { id: 13, image: jacket13, label: "Plain Toe Genuine Leather Dress Shoes", to: "13" },
    { id: 14, image: jacket14, label: "Plain Toe Genuine Leather Dress Shoes", to: "14" },
    { id: 15, image: jacket15, label: "Plain Toe Genuine Leather Dress Shoes", to: "15" },
