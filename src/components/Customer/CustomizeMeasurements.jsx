import { FaRegCheckCircle, FaRegClock, FaRegQuestionCircle, FaRegUser } from 'react-icons/fa';
...
const CustomizeMeasurements = () => {
	...
	return (
		<div className='relative flex justify-center'>
			<img src={measurement_bg} alt="" className='relative w-screen h-screen max-h-[calc(100vh-4rem)]' />
					...
					<div onClick={() => navigate("/customer/cart")}
						...
						<div className="p-6">
							...
							<p className="text-base text-white dark:text-neutral-50">
								You can skip entering your measurements now and provide them later.
							</p>
						</div>
					</div>
