...
const ChoosePantContrast = () => {
    return (
        <div className='flex flex-col'>
            <span className="p-5 text-2xl font-bold">Choose Colors</span>
            <div className='flex flex-col shadow-lg rounded-lg p-3'>

                <CustomCheckbox label="Belt Loops" />
            ...
            <div className='flex flex-col shadow-lg rounded-lg p-3'>
                ...
                <CustomCheckbox label="Back Pockets" />
                <div className='p-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-5'>
...
export default ChoosePantContrast