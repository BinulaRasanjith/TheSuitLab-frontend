...
export function WholeCostume(props) {
  ...
  return (
    <group {...props} dispose={null} position={[props.control.x, props.control.y, props.control.z]}
      ...
      <mesh geometry={nodes.Jacket_ChestPocket.geometry} material={materials['Suit_WineVelvetSolid.005']} position={[0, 0, 0.009]} rotation={[-Math.PI / 2, 0, 0]} scale={0.025} visible={!hide.Jacket && (pocket === '2-straight' || pocket === '2-straight-flaps' || pocket === null) ? false : true} ><meshStandardMaterial {...(pocketColor === null ? TextureProps[material] : pocketTextureProps[pocketColor])} /></mesh>
