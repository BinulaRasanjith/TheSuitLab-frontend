    ...
    return (
        <div className='flex flex-col md:flex-row items-center justify-center md:lg-x-60 lg:gap-x-80 bg-white  my-5 mx-5'>
            <div className='flex flex-col items-start justify-start'>
                ...
                <div>
                    <button type="button" class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-sm px-10 py-2.5 my-3 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Visit</button>
                </div>
            </div>
            <div className=''>
