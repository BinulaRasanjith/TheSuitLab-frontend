...
Command: npx gltfjsx@6.2.11 public/models/NewSuit.gltf 
*/
...
export function OrderedDesign(props) {
	const { nodes, materials } = useGLTF("/models/NewSuit.gltf");

	const material = "MAT0000000004";
	const backPocket = null;
	const trouser = "no-vent";
	const jacketButtons = "2S";
	const lapel = "peak-lapel";
	const pocket = null;
	const pocketColor = null;
	const sleeveButtons = null;
	const buttonColor = "none";
	...
	return (
		...
		>
			<mesh
				...
				scale={0.025}
				visible={lapel === "notch-lapel" ? true : false}
			>
				<meshStandardMaterial {...TextureProps[material]} />
			</mesh>
			<mesh
				geometry={nodes.Jacket_Suit_Peak_NoVents.geometry}
				material={materials["b0b0b0.001"]}
				position={[0.004, 0.013, 0.003]}
				rotation={[-Math.PI / 2, 0, 0]}
				scale={0.025}
				visible={lapel === "peak-lapel" ? true : false}
			>
				<meshStandardMaterial {...TextureProps[material]} />
			</mesh>
			...
			<mesh
				geometry={nodes.Jacket_6_button.geometry}
				material={materials.Button}
				position={[0, 0, 0.018]}
				rotation={[-Math.PI / 2, 0, 0]}
				scale={0.025}
				visible={jacketButtons === "6D3" ? true : false}
			>
				<meshStandardMaterial color={colors[buttonColor]} />
			</mesh>
			<mesh
				geometry={nodes.Jacket_Front_1_Button.geometry}
			...
			<mesh
				...
				material={materials["b0b0b0.002"]}
				rotation={[-Math.PI / 2, 0, 0]}
				scale={0.025}
				visible={trouser === "no-vent" || trouser === null ? true : false}
			>
				<meshStandardMaterial {...TextureProps[material]} />
			</mesh>
			<mesh
				...
				rotation={[-Math.PI / 2, 0, 0]}
				scale={0.025}
				visible={backPocket === "with-btn" ? true : false}
			>
				<meshStandardMaterial color={colors[buttonColor]} />
			</mesh>
			...
			<mesh
				...
				material={materials["Suit_NavyWindowpane.003"]}
				position={[0, 0, 0.023]}
				rotation={[-Math.PI / 2, 0, 0]}
				scale={0.025}
				visible={
					pocket === "2-straight-flaps" ||
			...
			>
				<meshStandardMaterial
					{...(pocketColor === null
						? TextureProps[material]
						: pocketTextureProps[pocketColor])}
				/>
			</mesh>
			<mesh
				geometry={nodes.Jacket_Suit_PocketLine.geometry}
				material={materials["Suit_WineVelvetSolid.004"]}
				position={[0, 0, 0.025]}
				rotation={[-Math.PI / 2, 0, 0]}
				scale={0.025}
				visible={
					pocket === "2-straight" || pocket === "2-straight-1-ticket"
						? true
						: false
				}
			>
			...
			<mesh
				geometry={nodes.Pants_Back_PocketLine.geometry}
				material={materials["b0b0b0.005"]}
				rotation={[-Math.PI / 2, 0, 0]}
				scale={0.025}
				visible={
					backPocket === "no-btn" || backPocket === "with-btn" ? true : false
				}
			>
				<meshStandardMaterial
					{...(pocketColor === null
			...
			<mesh
				geometry={nodes.Pants_Normal.geometry}
				material={materials.Suit_OlivieSolidBrushedTwill}
				position={[-0.002, 0.008, 0.009]}
				rotation={[-Math.PI / 2, 0, 0]}
				scale={0.025}
				visible={trouser === "center-vent" ? true : false}
			>
				<meshStandardMaterial {...TextureProps[material]} />
			</mesh>
			<mesh
				geometry={nodes.jacket_2_Button.geometry}
				material={materials["Button.007"]}
				position={[-0.024, -0.084, -0.002]}
				rotation={[-Math.PI / 2, 0, 0]}
				scale={0.025}
				visible={jacketButtons === "4D2" ? true : false}
			>
				<meshStandardMaterial color={colors[buttonColor]} />
			</mesh>
			<mesh
				geometry={nodes.Jacket_ChestPocket.geometry}
				material={materials["Suit_WineVelvetSolid.005"]}
				position={[0, 0, 0.009]}
				rotation={[-Math.PI / 2, 0, 0]}
				scale={0.025}
				visible={
			...
			<mesh
				geometry={nodes.jacket_Sleve_3_Button.geometry}
				material={materials["Button.001"]}
				position={[0, 0, -0.001]}
				rotation={[-Math.PI / 2, 0, 0]}
				scale={0.025}
				visible={sleeveButtons === "3-standard" ? true : false}
			>
				<meshStandardMaterial color={colors[buttonColor]} />
			</mesh>
			<mesh
				geometry={nodes.jacket_Sleve_2_Button.geometry}
				material={materials["Button.003"]}
				position={[0, 0, 0.001]}
				rotation={[-Math.PI / 2, 0, 0]}
				scale={0.025}
				visible={sleeveButtons === "2-standard" ? true : false}
			>
				<meshStandardMaterial color={colors[buttonColor]} />
			</mesh>
			<mesh
				geometry={nodes.Jacket_Sleve_4_Button.geometry}
				material={materials["Button.008"]}
				position={[0, 0, 0.001]}
				rotation={[-Math.PI / 2, 0, 0]}
				scale={0.025}
				visible={sleeveButtons === "4-standard" ? true : false}
			></mesh>
			<mesh
				geometry={nodes.Jacket_Front_1_Button001.geometry}
				material={materials["Button.004"]}
				position={[0, -0.087, 0.005]}
				rotation={[-Math.PI / 2, 0, 0]}
				scale={0.025}
				visible={
					jacketButtons === "2S" || jacketButtons === "4D2" ? true : false
				}
			>
				<meshStandardMaterial color={colors[buttonColor]} />
			</mesh>
