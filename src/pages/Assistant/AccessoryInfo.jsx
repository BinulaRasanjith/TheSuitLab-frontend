...
const Accessory = () => {
    ...
    const [accessoryInfo, setAccessory] = useState({});
    ...
    return (
        <>
            <div className="2xl:px-20 md:px-6 px-4 pt-5">
                <a href="/assistant/accessories" className="text-gray-200 bg-black hover:bg-gray-500 py-2 px-5 rounded-md">
                    Back
                </a>
            </div>
                ...
                <div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
                    <div className="">
                        <h1 className="lg:text-2xl text-xl font-semibold lg:leading-6 leading-7 text-gray-900 mt-2">
                            {accessoryInfo.accessory.itemName}
                        </h1>
                        <p className="text-sm py-2 leading-none text-gray-600 ">
                            {accessoryInfo.accessory.accessoryType}
                        </p>
                    </div>
                    <div className="border-b border-gray-200 pb-6">
                        <p className="text-base leading-4 mt-7 text-gray-600">
                            Product Code: {accessoryInfo.accessory.itemId}
                        </p>
                    </div>
                    <div className="py-4 border-b border-gray-200 flex items-center justify-between">
                        ...
                        <div className="flex items-center justify-center">
                            <p className="text-sm leading-none text-gray-600 ">
                                {accessoryInfo.accessory.material}
                            </p>
                    ...
                    <div className="py-4 border-b border-gray-200 flex items-center justify-between">
                        ...
                        <div className="flex items-center justify-center">
                            <p className="text-sm leading-none text-gray-600  mr-3">{accessoryInfo[Object.keys(accessoryInfo)[1]].size}</p>
                    ...
                    <div className=" border-gray-200 pb-6">
                        <p className="text-base leading-4 mt-7 text-gray-600">Colour: {accessoryInfo.accessory.color}</p>
