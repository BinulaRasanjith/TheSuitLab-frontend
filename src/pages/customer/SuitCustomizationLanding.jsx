	...
	return (
		<div>
			...
			<div className="flex flex-col items-start absolute top-20 left-2 md:left-10">
				...
				<div className="text-white pb-5 md:px-10 w-full md:w-96 float-left">
					100% Made to Measure Suits Are you looking for a custom suit that will
					make you look stunning and express your personal style to the fullest?
					Our suits are not only high-quality but they are also hand tailored to
					your measurements. Choose from more than 150 fabrics and various
					details and design your own outfit.
				</div>
				...
				<Menu>
					<MenuButton
						ml={10}
						as={Button}
						rightIcon={<BiSolidDownArrow className="text-xs" />}
					>
						Design Your Own
					</MenuButton>
					<MenuList>
						<MenuItem onClick={goToJacketCustomization}>
							Customize Jacket
						</MenuItem>
						<MenuItem onClick={goToPantCustomization}>Customize Pant</MenuItem>
						<MenuItem onClick={goToJacketAndPantCustomization}>
							Customize Jacket & Pant
						</MenuItem>
					</MenuList>
				</Menu>
			</div>
