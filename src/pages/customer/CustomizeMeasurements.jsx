...
const CustomizeMeasurements = () => {
	...
	return (
		<div className="w-full min-h-[calc(100vh-64px)]">
			...
			<div
				className={`mt-4 transition-opacity ease-in-out duration-1000 flex flex-col ${
					measurementType === "current-sizes"
						? "opacity-100"
						: "opacity-0 hidden"
				}`}
			>
			...
			<div
				className={`mt-4 transition-opacity ease-in-out duration-1000 flex flex-col ${
					measurementType === "Standard" ? "opacity-100" : "opacity-0 hidden"
				}`}
			>
			...
			<div
				className={`mt-4 transition-opacity ease-in-out duration-1000 flex flex-col ${
					measurementType === "custom" ? "opacity-100" : "opacity-0 hidden"
				}`}
			>
				<div className="flex justify-center m-5">
					<Select placeholder="Select Unit" width="400px">
