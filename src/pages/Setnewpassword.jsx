                        ...
                        <form className='flex flex-col align-center justify-center float-left lg:pl-10 lg:pr-10 pl-2 pr-2'>
                            ...
                            <div className='lg:hidden flex flex-col align-center justify-center'>
                                <div className='flex flex-col  lg:pl-10 lg:pr-10 pl-5 pr-5 pb-5 max-w-2xl float-left'>
                                    <input className='outline rounded text-xl pl-5 pb-2 pt-2 outline-gray-300' id="password" name="password" placeholder='Enter New password' type="password" />
                                </div>
                                <div className='flex flex-col  lg:pl-10 lg:pr-10 pl-5 pr-5 pb-5 max-w-2xl float-left'>
                                    <input className='outline rounded text-xl pl-5 pb-2 pt-2 outline-gray-300' id="password" name="password" placeholder='Re-Enter New password' type="password" />
                                </div>
                            </div>

                            <div className="lg:block hidden relative z-0 w-full mb-6 group max-w-2xl">
                                <input className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 focus:outline-none focus:ring-0 peer" id="floating_password" name="floating_password" placeholder=" " required type="password" />
                                <label className="peer-focus:font-medium absolute text-lg text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6" htmlFor="floating_password">Enter New password</label>
                            </div>
                            <div className="lg:block hidden relative z-0 w-full mb-6 group max-w-2xl">
                                <input className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 focus:outline-none focus:ring-0 peer" id="floating_password" name="floating_password" placeholder=" " required type="password" />
                                <label className="peer-focus:font-medium absolute text-lg text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6" htmlFor="floating_password">Re-Enter New Password</label>
                            </div>
