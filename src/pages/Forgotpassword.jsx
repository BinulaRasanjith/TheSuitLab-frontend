                    ...
                    <div className='flex flex-col bg-white drop-shadow-2xl rounded-3xl py-5 px-0 sm:px-3'>
                        ...
                        <form className='flex flex-col align-center justify-center float-left'>
                            ...
                            <div className="lg:block hidden relative z-0 mb-6 w-full group pl-10 pr-10 max-w-2xl">
                                ...
                                <label htmlFor="floating_email" className="peer-focus:font-medium absolute text-lg text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-10 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Email address</label>
                            </div>
