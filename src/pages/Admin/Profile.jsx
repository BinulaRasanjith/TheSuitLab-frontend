                        ...
                        <div className="flex flex-row mt-8">
                            ...
                            <div className="flex flex-col ml-20">
                                ...
                                <div className="flex-row mt-6 grid grid-cols-2 mb-1">
                                    ...
                                    <input className="border border-gray-200 rounded-xl  focus:outline-none focus:border-gray-500" type="text" value='John' />
                                </div>
                                <div className="flex-row mt-6 grid grid-cols-2 mb-1">
                                    <label className="text-md text-gray-500">Last Name</label>
                                    <input className="border border-gray-200 rounded-xl  focus:outline-none focus:border-gray-500" type="text" value='Doe' />
                                </div>
                                <div className="flex-row mt-6 grid grid-cols-2 mb-1">
                                    <label className="text-md text-gray-500">Address</label>
                                    <input className="border border-gray-200 rounded-xl  focus:outline-none focus:border-gray-500" type="text" value='Bambalapitiya, Colombo 04' />
                                </div>
                                <div className="flex-row mt-6 grid grid-cols-2 mb-1">
                                    <label className="text-md text-gray-500">Contact</label>
                                    <input className="border border-gray-200 rounded-xl  focus:outline-none focus:border-gray-500" type="text" value='' />
                                </div>
                                <div className="flex-row mt-6 grid grid-cols-2 mb-1">
                                    <label className="text-md text-gray-500">Password</label>
                                    <input className="border border-gray-200 rounded-xl  focus:outline-none focus:border-gray-500" type="password" value='dfgghhhrh' />
                                </div>
