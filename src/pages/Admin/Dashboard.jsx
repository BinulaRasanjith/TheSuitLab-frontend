    ...
    <div className="flex flex-row">
      <div className="flex flex-col bg-gray-100 h-screen justify-between w-60 py-4 px-2">
        <div className="flex flex-col flex-auto">
          ...
          <div className="p-2 mb-2">
            <div className="flex flex-row space-x-3">
              ...
              <h4 class="font-bold text-gray-500 hover:text-black-200">Dashboard</h4>
            </div>
          </div>
          ...
          <div className="p-2 mb-2">
            <div className="flex flex-row space-x-3">
              ...
              <h4 class="font-bold text-gray-500 hover:text-black-200">Employees</h4>
            </div>
          </div>
          ...
          <div className="p-2 mb-2">
            <div className="flex flex-row space-x-3">
              ...
              <h4 class="font-bold text-gray-500 hover:text-black-200">Customers</h4>
            </div>
          </div>
          ...
          <div className="p-2 mb-2">
            <div className="flex flex-row space-x-3">
              ...
              <h4 class="font-bold text-gray-500 hover:text-black-200">Orders</h4>
            </div>
          </div>
          ...
          <div className="p-2 mb-2">
            <div className="flex flex-row space-x-3">
              ...
              <h4 class="font-bold text-gray-500 hover:text-black-200">Notifications</h4>
            </div>
          </div>
          ...
          <div className="p-2 mb-2">
            <div className="flex flex-row space-x-3">
              ...
              <h4 class="font-bold text-gray-500 hover:text-black-200">Reviews</h4>
            </div>
          </div>
          ...
          <div className="p-2 mb-2">
            <div className="flex flex-row space-x-3">
              ...
              <h4 class="font-bold text-gray-500 hover:text-black-200">Profile</h4>
            </div>
          </div>
        ...
        <div className="flex flex-col ">
          <button className=' rounded-md shadow-lg bg-white  py-2 p-2 m-2'>Logout</button>
        </div>
      </div>
