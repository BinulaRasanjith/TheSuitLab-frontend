          ...
          <div className=" min-h-screen bg-white">
            ...
            <div className="mt-5   grid lg:grid-cols-3 md:grid-cols-2 p-4 gap-2">
              <div className="bg-white p-8 flex-col rounded shadow-lg">
                <b className='flex flex-row text-gray-500'>PERFOMANCE</b>
                <img alt="image" className="w-260 h-380 object-cover rounded-md shadow-lg" src={bar} /></div>
              ...
              <div className="flex flex-col p-8 bg-white rounded shadow-lg">
                ...
                <img alt="image" className="w-260 h-380 object-cover rounded-md shadow-lg" src={chart} />
              </div>
